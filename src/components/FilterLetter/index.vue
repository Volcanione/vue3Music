<template>
  <div class="filterLetter" @touchstart.capture="letterTouchStart" @touchmove.capture="letterTouchMove" ref="filterLetterRef" @touchend.capture="tipShow=false">
    <span class="letter" :class="{active:l===active}" v-for="l in letter" :key="l" @click="active=l">{{l}}</span>
  </div>
