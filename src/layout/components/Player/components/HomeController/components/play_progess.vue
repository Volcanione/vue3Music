  ...
  <div class="proPlay">
    ...
    <svg viewBox="0 0 100 100">
      <path d="
        ...
        a 47 47 0 1 1 0 94
        a 47 47 0 1 1 0 -94
        " stroke="#e5e9f2" stroke-width="7" fill="none" class="el-progress-circle__track" style="stroke-dasharray: 295.31px, 295.31px; stroke-dashoffset: 0px;"></path>
      <path d="
        M 50 50
        m 0 -47
        a 47 47 0 1 1 0 94
        a 47 47 0 1 1 0 -94
        " stroke="#20a0ff" fill="none" stroke-linecap="round" stroke-width="7" class="el-progress-circle__path"
        :style="`stroke-dasharray: ${295.31/100*progess}px, 295.31px; stroke-dashoffset: 1px; transition: stroke-dasharray 0.6s ease 0s, stroke 0.6s ease 0s;`">
      </path>
    </svg>
